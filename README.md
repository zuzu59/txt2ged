...
Copier le contenu du fichier prompt.txt dans le chat Coplilot, ajouter comme annexe le fichier input.txt et cliquer sur la flèche *send*
...
## Remarques
J'ai constaté, avec les modèles en local sur Ollama, que plus le *prompt* était détaillé, plus il perdait les pédalles et n'arrivait à rien. Si on fait un *prompt* minimaliste, il s'en sort quasiement du 1er coup !
